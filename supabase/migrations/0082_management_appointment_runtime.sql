...
grant execute on function public.create_management_appointment(uuid, uuid, timestamptz, uuid, text)
to authenticated;
...
grant execute on function public.update_management_appointment(uuid, uuid, uuid, timestamptz, uuid, text)
to authenticated;
